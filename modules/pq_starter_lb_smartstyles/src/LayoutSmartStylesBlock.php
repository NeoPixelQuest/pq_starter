...
namespace Drupal\pq_starter_lb_smartstyles;
...
class LayoutSmartStylesBlock {
   ...
   */
  protected $formGroupName = 'pq_layout_block_customization';
  ...
  public function updateLayoutBuilderForm($form) {
    ...
    if (in_array($this->layoutBuilderFormValidationName, $form['#submit'])) {
      ...
      array_unshift($form['#submit'], '_pq_starter_lb_smartstyles_layout_builder_styles_submit_block_form');
    }
